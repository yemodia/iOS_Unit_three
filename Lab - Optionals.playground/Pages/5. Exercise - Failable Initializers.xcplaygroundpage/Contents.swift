 ...
 */
var instance = Computer (ram: 2, yearManufactured: 2013)
var fail = Computer(ram: 1, yearManufactured: 1958)
if let instance = instance{
    print(instance.ram, instance.yearManufactured)
}
if let fail = fail{
    print(fail.ram, fail.yearManufactured)
